...
async function testExactReplication() {
  try {
    ...
    const TARGET_ETH = 0.03;   // Use SAME amount as successful
    const SCALE_FACTOR = TARGET_ETH / ORIGINAL_ETH; // 1.0 - no scaling
